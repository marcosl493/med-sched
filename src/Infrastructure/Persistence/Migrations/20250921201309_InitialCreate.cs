        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HashedPassword = table.Column<string>(type: "character varying(44)", maxLength: 44, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Schedules_Physicians_PhysicianId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_PatientId_ScheduleId_Status",
                table: "Appointments",
                columns: new[] { "PatientId", "ScheduleId", "Status" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Schedules_PhysicianId_StartTime_EndTime",
                table: "Schedules",
                columns: new[] { "PhysicianId", "StartTime", "EndTime" },
                unique: true);
